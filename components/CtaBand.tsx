    ...
    <section className="relative overflow-hidden bg-navy-ink">
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col gap-10 px-6 py-20 sm:py-24 md:flex-row md:items-end md:justify-between">
        <div className="max-w-2xl">
          ...
          <h2 className="text-display-sm mt-5 text-white">Get your project secured</h2>
        ...
        <div className="flex shrink-0 flex-col gap-3 sm:flex-row md:flex-col lg:flex-row">
          <Link
            href="/contact"
            className="group inline-flex items-center justify-center gap-3 bg-sky px-8 py-4 text-sm font-semibold uppercase tracking-wider text-navy-ink transition-colors hover:bg-white"
          >
            Request a quote
          ...
          <a
            ...
            className="inline-flex items-center justify-center border border-white/30 px-8 py-4 text-sm font-semibold uppercase tracking-wider text-white transition-colors hover:border-sky hover:bg-white/10"
          >
            Email us
          </a>
        </div>
